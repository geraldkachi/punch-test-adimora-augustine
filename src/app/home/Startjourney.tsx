    ...
    return (
        <div className=' py-4 h-full w-full md:py-20 space-y-4'>
            ...
            <div className={`max-w-7xl mx-3 xl:mx-auto sm:flex flex-row items-center justify-center gap-5`}>
                {/* section 1 */}
                <div className="-skew-y-2 flex items-center flex-1 w-full bg-[#EDEFFF] overflow-hidden">
                    ...
                    <div className="skew-y-2 flex flex-col flex-1"> 
            ...
            <div className={`max-w-7xl mx-3 xl:mx-auto sm:flex flex-row items-center justify-center gap-5`}>
                 {/* section 2 */}
                 <div className="-skew-y-2 flex items-center flex-1 w-full bg-[#FFF7E2] overflow-hidden">
                    <div className="skew-y-2 flex flex-col flex-1 pl-4 md:pl-8 pt-4 md:pt-8">
                        <div className="flex flex-col mt-7 md:mt-14">
                            <div className="flex items-start gap-2">
            ...
            <div className={`max-w-7xl mx-3 xl:mx-auto sm:flex flex-row items-center justify-center gap-5`}>
                 {/* section 3 */}
                 <div className="-skew-y-2 flex items-center flex-1 w-full bg-[#F3F3F3] overflow-hidden">
                    <div className="skew-y-2 flex flex-col flex-1 pl-4 md:pl-8 pt-4 md:pt-8">
                        <div className="flex flex-col mt-7 md:mt-14">
                            <div className="flex items-start gap-2">
