...
const WhychooseZwilt = () => {
    return (
        <div>
            <div className="-skew-y-2 bg-[#FDFDFF  py-10 px-3 sm:px-0 md:pl-20 relative z-0  bg-gradient-to-b from-[#FDFDFF] from-10% via-[#F3F4FF] via-70% to-[#F3F4FF] 10% to-90%">
                <div className={`grid grid-cols-6 skew-y-2 max-w-full xl:mx-auto gap-5 py-0`}>
                    ...
                    <div className="col-span-4 flex flex-col flex-1 py-10 pl-4 md:pl-8 pt-4 md:pt-8 bg-white rounded-[20px]">
                        <div className="flex flex-col">
                            <motion.div variants={navVariants} className="flex items-start gap-2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <motion.p variants={navVariants} className={`flex items-center gap-3 my-1 text-start text-[#202229CC] font-normal text-base leading-[24px]`}>
